 ...
 * @author Asus
 */
public class ifrmListadoAgencia extends javax.swing.JInternalFrame {

    /**
     * Creates new form ifrmListadoAgencia
     */
    public ifrmListadoAgencia() {
        initComponents();
    }
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        // TODO add your handling code here:
        activar(false);
        lista = BLAgencia.listarAgencias();
            llenarTabla();
...
private void llenarTabla() {
        ...
        while(iterador.hasNext()) {
            agencia = iterador.next();
            fila[0] = agencia.getNombre();
            fila[1] = agencia.getDireccion();
            modelo.addRow(fila);            
        }
        tblAgencia.setModel(modelo);
    }
...
private DefaultTableModel modelo;
    ...
    private String columnas[] = {"Nombre", "Direccion"};
    private Object fila[] = new Object[columnas.length];
    private Iterator<Agencia> iterador;
